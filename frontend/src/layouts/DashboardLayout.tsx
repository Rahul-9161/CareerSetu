...
const navConfig: Record<string, NavItem[]> = {
  student: [
    ...
    { label: 'Alumni Connect', href: '/student/alumni', icon: GraduationCap },
  ...
  faculty: [
    ...
    { label: 'Curriculum Skills', href: '/faculty/curriculum', icon: BookOpen },
    { label: 'Endorsements', href: '/faculty/endorsements', icon: Award },
    { label: 'Capstone Projects', href: '/faculty/projects', icon: Layers },
    { label: 'Mock Evaluations', href: '/faculty/evaluations', icon: Target },
  ],
  alumni: [
    { label: 'Overview', href: '/alumni/overview', icon: LayoutDashboard },
    { label: 'Mentorship Slots', href: '/alumni/mentorship', icon: Calendar },
    { label: 'Referral Desk', href: '/alumni/referrals', icon: Briefcase },
    { label: 'Directory', href: '/alumni/directory', icon: Users },
    { label: 'AMA Community', href: '/alumni/community', icon: MessageSquare },
  ],
  compliance: [
    { label: 'Overview & Oversight', href: '/compliance/overview', icon: LayoutDashboard },
  ],
}
  ...
  return (
    <div className="flex h-screen overflow-hidden" style={{ background: 'var(--surface-base)' }}>
      ...
      <motion.aside
        ...
        {/* Logo */}
        <div className="flex items-center gap-2.5 px-5 py-4 border-b" style={{ borderColor: 'var(--border-light)' }}>
