...
if (-not $backendRunning) {
    ...
    Start-Process -FilePath "powershell.exe" -ArgumentList "-NoExit", "-Command", "cd `"$backendPath`"; `$env:SPRING_PROFILES_ACTIVE='local'; & 'C:\tools\maven\apache-maven-3.9.9\bin\mvn.cmd' spring-boot:run" -WindowStyle Minimized
